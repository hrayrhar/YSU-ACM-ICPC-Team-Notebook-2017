...
\pagestyle{fancy}
\fancyhead[L]{Yerevan State University}
\fancyhead[R]{\thepage}
\fancyfoot[C]{}
...
\title{\vspace{-4ex}\Large{Yerevan State University ACM ICPC Team Notebook}}
\author{}
\date{}

\begin{document}
\begin{landscape}
\begin{multicols}{3} % change number of columns here
